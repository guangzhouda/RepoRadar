...
class PayloadLocalizer:
    ...
    def _translate(self, requests: list[dict[str, str]], target_language: str) -> dict[str, Any]:
...
def build_localization_prompt(requests: list[dict[str, str]], target_language: str) -> str:
    ...
    return "\n".join(
        [
            ...
            'Schema: {"items":[{"full_name":"owner/repo","description":"...","rationale":"...","reject_reason":"..."}]}',
...
def _translation_requests(candidates: list[Any], target_language: str) -> list[dict[str, str]]:
    ...
    for raw_candidate in candidates:
        ...
        item: dict[str, str] = {"full_name": full_name}
        for field in ("description", "rationale", "reject_reason"):
...
def _set_i18n_field(candidate: dict[str, Any], field: str, language: str, value: str) -> None:
...
def _cache_key(requests: list[dict[str, str]], target_language: str, model_id: str) -> str:
    return json.dumps(
        {
            "model": model_id,
